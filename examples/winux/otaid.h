                             ...
                             public AudioSourceDataListener
{
    ...
    *m_Listener;
    ...
    void 
    OnAudioSourceData(AudioBuffer<int16_t> &audio)
    {
        AudioBuffer<int16_t> *abuffer = m_RingBuffer.GetHead();
    ...
    DoIdentification()
    {
        AudioBuffer<int16_t> *block = m_RingBuffer.Pull();
...
public:
        ...
        m_Listener      (nullptr)
    {
        ...
        AudioBuffer<int16_t> buffer (11025 * 3, 11025, 1, 0);
...
class StreamMonitoringResultsParser : public IdResultsListener
{
