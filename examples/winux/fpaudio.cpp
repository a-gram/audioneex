...
/// from files. It basically builds the "fingerprints database", so it can be 
/// used as a generic tool for that purpose.
///
/// To run the program, use the following command
///
/// fpaudio [-u <db_url>] [-m <match_type>] <audio_files_dir>
///
...
PrintUsage()
{
    std::cout << "\nUSAGE: fpaudio [-u <db_url>] [-m <match_type>] "
                                    "<audio_files_dir>\n\n";
}
